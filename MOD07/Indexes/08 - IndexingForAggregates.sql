...
-- DROP INDEX charge.CoveringWithInclude
-- DROP INDEX charge.Covering1
-- DROP INDEX charge.Covering2
...
-- what is the avg spending by people with the same last name?
SET STATISTICS IO ON
go

SELECT m.Lastname, avg(c.charge_amt) AS TotalSales
FROM dbo.charge AS c
